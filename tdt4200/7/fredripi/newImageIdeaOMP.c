...
static void gaussBlur(AccurateImage *imageOut, AccurateImage *imageIn,int size) {
...
static void performNewIdeaFinalization(AccurateImage *imageInSmall, 
...
static void perform5(AccurateImage *in, 
                     AccurateImage *out, 
...
#pragma omp parallel 
    {
        ...
        perform5(imageSmall, imageUnchanged, imageBuffer, 2);

        // Process the small case:
        perform5(imageBig, imageUnchanged, imageBuffer,3);
...
#pragma omp parallel
    {
        ...
        perform5(imageSmall, imageUnchanged, imageBuffer, 5);
...
#pragma omp parallel
    {
        ...
        perform5(imageBig, imageUnchanged, imageBuffer, 8);
